  ...
  return (
    ...
    >
      ...
      <div className="container px-10  flex gap-4 flex-col relative">
        ...
        {paragraph && (
          <p className="text-white text-xl w-full md:w-1/2 leading-9">
            {paragraph}
          </p>
        )}
        {showButtons && (
          <div className="flex-col md:flex-row flex gap-4">
            <Link href="/what-is-operation-streamline">
              <button className="text-white bg-blue-900 p-4 px-8 text-xl w-fit ">
                Learn More
              </button>
            </Link>
            <Link href="/what-you-can-do">
              <button className="text-gray-800 bg-white p-4 px-8 text-xl w-fit">
                What You Can Do
              </button>
            </Link>
          </div>
